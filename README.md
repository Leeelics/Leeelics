...
| 项目 | 技术栈 | 简介 |
|------|--------|------|
| **[leelicspace](https://github.com/Leeelics/leelicspace)** | Next.js · TypeScript · Tailwind | 个人博客系统，支持 Markdown、RSS、暗色模式 / *Personal blog with admin dashboard & RSS* |
| **[图文排版助手 Pro](https://github.com/Leeelics/social-media-card-creator)** | React · Tailwind · html2canvas | 社交媒体卡片生成器，支持 Markdown 与长文分页 / *Social media card creator with Markdown support* |
| **[SpeakSense](https://github.com/Leeelics/speaksense)** | FastAPI · Python · Whisper | AI 演讲分析工具，检测口头禅与语速 / *AI speech analysis for filler detection & pace* |
| **[note](https://github.com/Leeelics/note)** | - | 每周学习笔记 / *Weekly learning notes* |
